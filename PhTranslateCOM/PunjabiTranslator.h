// PunjabiTranslator.h : Declaration of the CPunjabiTranslator
...
class ATL_NO_VTABLE CPunjabiTranslator :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CPunjabiTranslator, &CLSID_PunjabiTranslator>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_PUNJABITRANSLATOR)


	BEGIN_COM_MAP(CPunjabiTranslator)
...
public:
	STDMETHOD(Translate)( BSTR inPhoneticString,  BSTR * pTranslatedString)
	{
		...
		::Translate(GetPunjabiTranslator(), (wchar_t*)inPhoneticString, strRet);
...
OBJECT_ENTRY_AUTO(__uuidof(PunjabiTranslator), CPunjabiTranslator)
