// SanskritTranslator.h : Declaration of the CSanskritTranslator
...
class ATL_NO_VTABLE CSanskritTranslator :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CSanskritTranslator, &CLSID_SanskritTranslator>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_SANSKRITTRANSLATOR)


	BEGIN_COM_MAP(CSanskritTranslator)
...
public:
	STDMETHOD(Translate)( BSTR inPhoneticString,  BSTR * pTranslatedString)
	{
		...
		::Translate(GetSanskritTranslator(), (wchar_t*)inPhoneticString, strRet);
...
OBJECT_ENTRY_AUTO(__uuidof(SanskritTranslator), CSanskritTranslator)
