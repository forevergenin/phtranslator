// GujaratiTranslator.h : Declaration of the CGujaratiTranslator
...
class ATL_NO_VTABLE CGujaratiTranslator :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CGujaratiTranslator, &CLSID_GujaratiTranslator>,
...
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_GUJARATITRANSLATOR)


	BEGIN_COM_MAP(CGujaratiTranslator)
...
public:
	STDMETHOD(Translate)( BSTR inPhoneticString,  BSTR * pTranslatedString)
	{
		...
		::Translate(GetGujaratiTranslator(), (wchar_t*)inPhoneticString, strRet);
...
OBJECT_ENTRY_AUTO(__uuidof(GujaratiTranslator), CGujaratiTranslator)
